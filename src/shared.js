export default {
    ...
    get frontend_base() {
        ...
        if(url.startsWith('http://localhost')) 
        {
            return "https://t3d-o-cdn.azureedge.net/vergunningschecker_3d";
            return "https://t3dstorage.z6.web.core.windows.net"
        }

        if(url.startsWith('https://t3dstorage')) 
        {
            return "https://t3dstorage.z6.web.core.windows.net/vergunningschecker_3d";
        }

        let urlstart = this.getStart(url);
        return `${urlstart}-cdn.azureedge.net/vergunningschecker_3d`;
